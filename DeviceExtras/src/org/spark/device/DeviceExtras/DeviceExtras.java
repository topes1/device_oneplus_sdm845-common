...
public class DeviceExtras extends PreferenceFragment
    ...
    private EarGainModeSwitch mEarGain;
    private Preference mDozeSettings;
    private Preference mKcal;
    private ListPreference mBottomKeyPref;
    private ListPreference mMiddleKeyPref;
    private ListPreference mTopKeyPref;
    private MicGainModeSwitch mMicGain;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // Earpiece gain
        mEarGain = (EarGainModeSwitch) findPreference(KEY_EAR_GAIN );
        if (mEarGain != null) {
            mEarGain.setEnabled(EarGainModeSwitch.isSupported());
        }

        // Microphone gain
        mMicGain = (MicGainModeSwitch) findPreference(KEY_MIC_GAIN );
        if (mMicGain != null) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.spark.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
